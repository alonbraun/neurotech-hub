...
export async function POST(req: NextRequest) {
  ...
  await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      ...
      to: email,
      subject: "You're subscribed to the NeuroTech Digest",
      html: `<div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;color:#1a1a1a">
  <h2 style="color:#1a3d6b;margin:0 0 12px">Welcome to the NeuroTech Digest</h2>
  ...
  <p style="margin-top:32px"><a href="https://neurotech.com" style="background:#1a3d6b;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:14px">Visit NeuroTech.com</a></p>
