...
function UnsubscribeForm() {
  ...
  return (
    <div className="max-w-md mx-auto px-5 py-24 text-center">
      <Link href="/" className="inline-block mb-8 text-[#1a3d6b] font-semibold text-lg">NeuoTech.com</Link>
      {status === "done" ? (
        <>
          <div className="text-4xl mb-4">👋</div>
          <h1 className="text-2xl font-semibold text-gray-900 mb-3">You're unsubscribed</h1>
          <p className="text-gray-500 mb-8">You won't receive the NeuoTech Digest anymore. You can resubscribe anytime.</p>
        ...
        <>
          ...
          <p className="text-gray-500 mb-8">Remove your email from the NeuoTech Digest mailing list.</p>
